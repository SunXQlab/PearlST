...
from histology_image_feature_extraction.modules import simCLR_model
from histology_image_feature_extraction.image_processing import CustomDataset, train_transform_64, test_transform, train_transform_32



# These code are cited from https://github.com/cmzuo11/stMVC
...
def train(net, data_loader, train_optimizer, args):
	...
	for pos_1, pos_2, _ in train_bar:
		...
		mask = (torch.ones_like(sim_matrix) - torch.eye(2 * args.batch_size_I, device=sim_matrix.device)).bool()
...
def extract_representation_simCLR_model(args, outDir='results', model_file=None, sub_path=None, file_code=None):
	...
	save_fileName = outDir + '/{}_simCLR_representation_resnet50.csv'.format(save_name_pre)
